...
function Dashboard() {
    ...
    useEffect(() => {
        ...
        // Fetch user data and repositories from the GitHub API
            ...
            <div className="dashboard">
                <header className="header">
                    ...
                    <div className='buttonsignout'>
                        <button className="btn btn-outline-success" style={{ marginLeft: '1000px' }} onClick={handleLogout}>Logout</button>
                    </div>
                </header>
